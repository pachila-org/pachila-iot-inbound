...
@Path("/sensor")
public class WaterLevelSensorService extends BaseService{
	private static final String CLASS_NAME = WaterLevelSensorService.class.getName();

	/*
	 *this is select from checkwater
	 */
	@GET
	@Path("/checkwater/{mac_id}/{user_id}")
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response Selectcheckwater(@PathParam("mac_id") String mac_id, @PathParam("user_id") String user_id) {
		final String METHOD_NAME = "Selectcheckwater";
		...
		StringBuffer payloadcontent = new StringBuffer(IOTPayLoadContentManager.getParameterValue(IOTConstants.CHECKWATERSTATUS));
