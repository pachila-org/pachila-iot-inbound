...
public class TemperatureSensorService extends BaseService{
	private static final String CLASS_NAME = TemperatureSensorService.class.getName();

	/*
	 *this is select from checktemperature
	 */
	@GET
	@Path("/checktemperature/{mac_id}/{user_id}")
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response Selectchecktemperature(@PathParam("mac_id") String mac_id, @PathParam("user_id") String user_id) {
		final String METHOD_NAME =  "Selectchecktemperature";
		...
		StringBuffer payloadcontent = new StringBuffer(IOTPayLoadContentManager.getParameterValue(IOTConstants.CHECKTEMPERASTATUS));
