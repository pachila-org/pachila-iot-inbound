...
@Path("/sensor")
public class DeviceFallSensorService extends BaseService{
  private static final String CLASS_NAME = DeviceFallSensorService.class.getName();

	/*
	 *this is select from checkfall
	 */
	@GET
	@Path("/checkfall/{mac_id}/{user_id}")
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response Selectcheckfall(@PathParam("mac_id") String mac_id, @PathParam("user_id") String user_id) {
		final String METHOD_NAME = "Selectcheckfall";
		...
		StringBuffer payloadcontent = new StringBuffer(IOTPayLoadContentManager.getParameterValue(IOTConstants.CHECKFALLSTATUS));
