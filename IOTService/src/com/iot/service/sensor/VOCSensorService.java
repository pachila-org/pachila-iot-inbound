...
@Path("/sensor")
public class VOCSensorService extends BaseService{
	private static final String CLASS_NAME = VOCSensorService.class.getName();

	/*
	 *this is select from checkvoc
	 */
	@GET
	@Path("/checkvoc/{mac_id}/{user_id}")
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response Selectcheckvoc(@PathParam("mac_id") String mac_id, @PathParam("user_id") String user_id) {
		final String METHOD_NAME = "Selectcheckvoc";
		...
		StringBuffer payloadcontent = new StringBuffer(IOTPayLoadContentManager.getParameterValue(IOTConstants.CHECKVOCSTATUS));
